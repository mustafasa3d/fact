    ...
    <section id="events" className="bg-[#f7f7f7] py-12">
      <div className="mx-auto max-w-6xl px-4 lg:px-0">
        <div className="mb-6 flex items-center justify-between">
          <h2 className="text-2xl font-bold text-primary">أهم الفعاليات</h2>
        </div>
        ...
        <div className="mt-6 flex items-center gap-3">
          ...
          <div className="ml-1 flex items-center gap-2">
            <button
              ...
              className="grid h-9 w-9 place-items-center rounded-full border border-primary text-primary transition-colors hover:bg-primary hover:text-white"
            >
...
function EventCard({ date, title }: EventCardProps) {
  return (
    <article className="rounded-md bg-primary p-5 text-white shadow-sm">
