  ...
  return (
    <section className="py-8">
      <Container className="grid grid-cols-1 gap-6 md:grid-cols-3">
        <div className="md:col-span-2 relative overflow-hidden bg-white">
          <div className="relative w-full max-lg:aspect-7/3 xl:h-[326px]">
            <Image
        ...
        <Link
          ...
          className="md:col-span-1 group relative block overflow-hidden bg-primary/10"
        >
          <div className="relative w-full h-full min-h-[210px]">
            <Image
              src="/assets/images/whoweare/video-thumb.png"
              alt="فيديو تعريفي"
              fill
